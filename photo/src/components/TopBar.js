...
class TopBar extends React.Component {
    ...
    createLoginStatus() {
        ...
        if (this.state.isLoggedIn) {
            ...
            retVal.push( <
                a href = "/photo-share.html#/addPhotos"
                className = "addPhotoLink"
                key = { 1 } >
                Add Photo <
                /a>
            );
            retVal.push("  ");
            retVal.push( <
                a href = "/photo-share.html#/favorites"
    ...
    render() {
        return ( <
            ...
            color = "inherit"
            className = "title" >
            Yingying Deng(Photo App Version: { this.state.version }) <
            /Typography> <
            Typography variant = "subtitle1"
            color = "inherit"
            align = "right"
            className = "title" > { this.createTitle() } <
            br / >
            <
            Typography variant = "body2"
            color = "inherit" > { this.createLoginStatus() } <
            /Typography> < /
            Typography > < /
            Toolbar > <
            /AppBar>
